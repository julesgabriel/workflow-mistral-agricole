...
description: >
  Guide pour créer et maintenir des skills dans .agents/skills/.
  Utilisez cette skill quand vous voulez créer une nouvelle SKILL.md,
  écrire des descriptions de skills, ou comprendre la structure des fichiers.
  Mots-clés : créer skill, SKILL.md, frontmatter, .agents/skills/
user-invocable: true  # <-- Ajoutez ceci
metadata:             # <-- Supprimez ou mettez internal: false
  internal: false     # <-- Optionnel
allowed-tools: [Read, Bash]  # <-- Ajoutez des outils si nécessaire
---
